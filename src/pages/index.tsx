...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Order Medicine Online`}</title>

        <meta
          name="description"
          content="Experience Order Medicine Online, your one-stop destination for all medical needs with WePharmacy. Simplifying healthcare, one click at a time."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1585435557343-3b092031a831?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwaGFybWFjeXxlbnwwfHx8fDE2OTc2MTQyOTh8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Order Medicine Online, your one-stop destination for all medical needs with WePharmacy. Simplifying healthcare, one click at a time.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Pharmacist" type="pharmacist" abilities={appConfig.ownerAbilities} />
