...
import { useRoqClient, usePharmacyFindManyWithCount } from 'lib/roq';
...
export function PharmacyListPage(props: PharmacyListPageProps) {
  ...
  const { data, error, isLoading, mutate } = usePharmacyFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.pharmacy.delete({ where: { id } });
      await mutate();
    } catch (error) {
